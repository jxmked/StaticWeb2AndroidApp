...
define("Level_1_Item_Boolean", ["require", "exports"], function (
  require,
  exports
) {
  "use strict";
  ...
  var Level_2_Item = (function () {
    ...
    Level_2_Item.prototype.createListSpan = function (name, value) {
      ...
      if (this.is_boolean(value)) {
        classNames.push(
          name == String(name) ? Level_2_Item.if_true : Level_2_Item.if_false
        );
...
define("main", [
  "require",
  "exports",
  "Level_1_Item_Boolean",
  "Level_2_Item",
], function (require, exports, Level_1_Item_Boolean_1, Level_2_Item_1) {
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
      ...
      Object.entries(mdnzr).forEach(function (entries) {
        ...
        if (value instanceof Object) {
          fragments.appendChild(
            new Level_2_Item_1.default(name, value).element
          );
        } else {
          fragments.appendChild(
            new Level_1_Item_Boolean_1.default(name, value).element
          );
        }
      });
